...
class Callback(Resource):
	def post(self):
		...
		status = pay()
		curr.execute("""UPDATE payments SET mpesa_reciept=%s, resultdesc=%s, status=%s WHERE mpesa_reciept='mpesa' AND resultdesc='resultdesc', status='no' """,(mpesa_reciept, resultdesc, status,))
		connection.commit()
